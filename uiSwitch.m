classdef uiSwitch < CSSBase
%UISWITCH  CSS-styled toggle switch component.
%
%   USAGE
%     sw = uiSwitch(parent, 'Text','Notifications', 'Value',true)
%     sw = uiSwitch(parent, 'Style','shadow')
%     sw.ValueChangedFcn = @(s,e) fprintf('State: %d\n', e.Value);
%
%   PROPERTIES
%     Value             Logical (true = on)                     default: false
%     Text              Label string                            default: 'Toggle'
%     ValueChangedFcn   @(src, evt) callback                   default: []
    ...
    % =====================================================================
    methods
        function obj = uiSwitch(parent, options)
            arguments
                parent = []
            ...
            if isempty(parent), parent = uifigure('Name','uiSwitch'); end
            obj@CSSBase(parent, ...
    ...
    methods (Access = protected)
        ...
        function html = buildHTML(obj)
            ...
            css = [ ...
                ...
                '#uihb{display:flex;align-items:center;gap:12px;' ...
                'padding:0 5px;cursor:var(--cursor,pointer);}' ...
                '.track{position:relative;display:inline-block;' ...
                'width:44px;height:22px;flex-shrink:0;}' ...
                '.track input{opacity:0;width:0;height:0;}' ...
            ...
            html = [ ...
                ...
                '<div id="uihb" class="css-surface">' ...
                '<label class="track">' ...
                '<input type="checkbox" id="chk"' checkedStr '>' ...
                '<span class="slider"></span>' ...
                '</label>' ...
                '<span class="lbl" id="cssbase-text">' CSSBase.htmlEscape(obj.Text) '</span>' ...
                '</div>' ...
                compJS '</body></html>' ...
            ];
        end
