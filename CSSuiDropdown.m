    ...
    methods (Access = protected)
        ...
        function html = buildHTML(obj)
            ...
            css = [ ...
                ...
                '.css-control{position:relative;flex:1 1 0;min-width:0;}' ...
                '.css-control.dd-sized{flex:none;width:var(--dd-width);}' ...
                'select{width:100%;' ...
                ...
                '.css-control::after{content:"\25BC";position:absolute;right:10px;' ...
                'top:50%;transform:translateY(-50%);font-size:9px;' ...
                'color:var(--color,#5f7080);pointer-events:none;}' ...
                '.css-disabled select{opacity:0.5;cursor:not-allowed;pointer-events:none;}' ...
            ];
            ...
            dropHTML = sprintf( ...
                '<div class="css-control css-surface%s"><select id="sel">%s</select></div>', ...
            ...
            html = [ ...
                ...
                '<div id="css-root" class="cssui-dropdown">' body '</div>' ...
                compJS '</body></html>' ...
            ];
        end
