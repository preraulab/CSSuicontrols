        ...
        function html = buildHTML(obj)
            ...
            script = [ ...
                ...
                'function fmtLabel(pct,tremStr){' ...
                    'var s=S.labelPrefix+": "+S.current+"/"+S.N;' ...
                    'if(S.showPct){s+="  "+pct.toFixed(1)+"%";}' ...
                    'if(S.showTime){s+=" | Time Remaining: "+tremStr;}' ...
                    'return s;' ...
                '}' ...
                ...
                'window.onCommand=function(c){' ...
                    'if(c.cmd==="startAnim"){' ...
                        'S={running:true,N:c.N,current:0,' ...
                            ...
                            'labelPrefix:c.labelPrefix||"Progress",' ...
                        ...
                        'setLabel(S.labelPrefix+": 0/"+S.N' ...
                            '+(S.showPct?"  0.0%":"")' ...
                            '+(S.showTime?" | Time Remaining: --:--":""));' ...
