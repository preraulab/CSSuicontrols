classdef CSSUIProgressBar < CSSBase
    ...
    methods
        ...
        function set.Value(obj, val)
            obj.Value = val;
            if ~obj.Updating_
                obj.pushVar('--progress-pct', sprintf('%.4f%%', val * 100));
            end
        end
        ...
        function set.LabelColor(obj, val)
            ...
            if ~obj.Updating_
                if isempty(val)
                    obj.pushVar('--label-color', '#414c57');
                else
        ...
        function set.BarHeight(obj, val)
            obj.BarHeight = val;
            if ~obj.Updating_
                obj.pushVar('--bar-height', sprintf('%.4f%%', val * 100));
            end
        end
        ...
        function html = buildHTML(obj)
            ...
            css = [ ...
                ...
                '.css-control{' ...
                  ...
                  'flex:none;' ...
                  'width:100%;' ...
                  'height:var(--bar-height,' sprintf('%.4f%%', obj.BarHeight*100) ');' ...
                  'background-color:var(--bg-color,#e0e0e0);' ...
                  'border-radius:var(--bar-radius,' obj.BarBorderRadius ');' ...
                  'overflow:hidden;' ...
                '}' ...
                '.css-bar{' ...
                  'flex-shrink:0;' ...
                  'width:var(--progress-pct,' sprintf('%.4f%%', obj.Value*100) ');' ...
                  'height:100%;' ...
                  'background:var(--color,#0072ff);' ...
                  'border-radius:var(--bar-radius,' obj.BarBorderRadius ');' ...
                  'transition:width var(--transition-duration,0.05s) linear;' ...
                '}' ...
                '.css-ticks{' ...
                  'position:absolute;' ...
                ...
                '.css-label{' ...
                  ...
                  'pointer-events:none;flex-shrink:1;min-height:0;' ...
                '}' ...
                '.css-label-on{' ...
                  'position:absolute;' ...
            ...
            html = [ ...
                ...
                '<style>' css '</style>' ...
                '</head><body>' ...
                '<div id="css-root" class="cssui-progressbar">' body '</div>' ...
                '</body></html>' ...
                ];
        end
